...
# Solución reportada en el documento final
REPORT_K = 4
...
def cluster_municipios(df: pd.DataFrame, report_k: int = REPORT_K):
    ...
    # el mejor silhouette score. Sin embargo, para mantener consistencia con el informe final,
    # la salida reportada se construye con k=4.
    df = df.copy()
